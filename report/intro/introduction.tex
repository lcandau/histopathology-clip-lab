...
\begin{itemize}
    ...
    \item External evaluation: NCT-CRC-HE-7K~\cite{kather2019nct} (close-shift colon), Chaoyang~\cite{zhu2021chaoyang} (different-hospital colon), and LungHist700~\cite{tabatabaei2024lunghist} (different-source lung).

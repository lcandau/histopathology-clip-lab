...
\begin{itemize}
    ...
    \item Training source: LC25000 (5-class, lung + colon).
    \item External evaluation: NCT-CRC-HE-7K (close-shift colon), Chaoyang (different-hospital colon), and LungHist700 (different-organ lung).
    \item Reference points: PLIP zero-shot (no LC25000 supervision) and a plain image classifier (no CLIP architecture).
\end{itemize}
